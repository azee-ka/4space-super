-- Add pin timing fields and retention update helper
...
-- =====================================================
-- ROOM RETENTION UPDATE (MEMBER-AWARE)
-- =====================================================
...
DECLARE
  ...
  permission TEXT;
BEGIN
  -- Ensure room settings row exists
  SELECT rs.settings
  INTO settings
  ...
  IF settings IS NULL THEN
    ...
    VALUES (room_id_input, jsonb_build_object('messageRetention', retention_input))
