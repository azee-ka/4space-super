  ...
  public: {
    Tables: {
      ai_conversations: {
        ...
        Relationships: [
          {
            foreignKeyName: "ai_conversations_room_id_fkey"
            columns: ["room_id"]
            isOneToOne: false
      ...
      message_label_assignments: {
        ...
        Relationships: [
          {
            foreignKeyName: "message_label_assignments_label_id_fkey"
            columns: ["label_id"]
            isOneToOne: false
            referencedRelation: "message_labels"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "message_label_assignments_message_id_fkey"
            columns: ["message_id"]
            isOneToOne: false
            referencedRelation: "messages"
            referencedColumns: ["id"]
      ...
      message_labels: {
        ...
        Relationships: [
          {
            foreignKeyName: "message_labels_space_id_fkey"
            columns: ["space_id"]
            isOneToOne: false
            referencedRelation: "spaces"
            referencedColumns: ["id"]
      ...
      messages: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "messages_forward_from_id_fkey"
            columns: ["forward_from_id"]
            isOneToOne: false
            referencedRelation: "messages"
            referencedColumns: ["id"]
          },
      ...
      user_kept_messages: {
        ...
        Relationships: [
          {
            foreignKeyName: "user_kept_messages_message_id_fkey"
            columns: ["message_id"]
            isOneToOne: false
            referencedRelation: "messages"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "user_kept_messages_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      user_saved_messages: {
        ...
        Relationships: [
          {
            foreignKeyName: "user_saved_messages_message_id_fkey"
            columns: ["message_id"]
            isOneToOne: false
            referencedRelation: "messages"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "user_saved_messages_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
