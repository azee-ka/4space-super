...
type LanguageOption = 'English' | 'Spanish' | 'French' | 'German' | 'Italian' | 'Portuguese' | 'Japanese' | 'Korean' | 'Chinese' | 'Hindi' | 'Arabic';

const OPTIONS: Array<{ value: LanguageOption; label: string; nativeName: string }> = [
...
export default function LanguageScreen() {
  ...
  const currentValue = (params.current as LanguageOption) || 'English';

  const handleSelect = (value: LanguageOption) => {
    // In a real app, you'd save this to state/storage and restart the app
    router.back();
  };
